...
def research_node(state: State) -> dict:
    ...
    if state.get("mode") == "open_book":
        ...
        # Keep items with no date (Tavily often omits published_at) OR within recency window
...
def _openai_generate_image_bytes(prompt: str, size: str = "1024x1024", quality: str = "medium") -> bytes:
    """
    Returns raw PNG image bytes generated by OpenAI gpt-image-1.
    Reuses the existing OPENAI_API_KEY — no extra key needed.
    """
    import base64
